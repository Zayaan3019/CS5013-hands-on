...
public class PriceEngine {
    ...
    public static Money quote(Order order, Customer customer) {
        ...
        // 4. Loyalty-tier discount (tier 1: 1-2y 2%, tier 2: 3-4y 5%, tier 3: 5+y 10%)
    ...
    /**
     * Applies the loyalty-tier discount to {@code running} based on how many
     * years the customer has been loyal, and returns the updated total.
